...
import fr.baptiste_masoud.online_multiplayer_wordle.messages.c_to_s.ClientToServerMessageType;
import fr.baptiste_masoud.online_multiplayer_wordle.messages.c_to_s.SetNameMessage;
import fr.baptiste_masoud.online_multiplayer_wordle.messages.c_to_s.SubmissionMessage;
...
public class MessageReader extends Thread {
    ...
    private void handleMessage(ClientToServerMessage message) {
        switch (message.getMessageType()) {
            case DISCONNECT -> player.getGame().end();
